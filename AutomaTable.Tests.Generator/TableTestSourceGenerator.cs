...
namespace AutomaTable.Tests.Generator
{
    [Generator]
    public sealed class TableTestSourceGenerator : IIncrementalGenerator
    {
        ...
        private const string IdNamespace = "AutomaTable.Primitives";
            ...
            context.RegisterSourceOutput(tables, static (sourceContext, models) =>
            {
                foreach (var model in models)
                {
                    sourceContext.AddSource(
                        "AutomaTable.Tests.Generated." + model.RowName + "ValidationTests.g.cs",
        ...
        private static string Render(TableTestModel model)
        {
            ...
            builder.AppendLine();
            builder.AppendLine("namespace AutomaTable.Tests.Generated");
            builder.AppendLine("{");
            ...
            foreach (var asset in model.Assets)
            {
                ...
                builder.AppendLine("        {");
                builder.AppendLine("            global::AutomaTable.Tests.Infrastructure.TableDataAssertions.AssertAssetAddressExists(");
            ...
            foreach (var reference in model.References)
            {
                ...
                builder.AppendLine("        {");
                builder.AppendLine("            global::AutomaTable.Tests.Infrastructure.TableDataAssertions.AssertReferenceExists(");
                builder.Append("                \"").Append(Escape(model.RowName)).AppendLine("\",");
                builder.AppendLine("                \"Id\",");
            ...
            IReadOnlyList<string> columns)
        {
            ...
            builder.AppendLine("        {");
            builder.AppendLine("            global::AutomaTable.Tests.Infrastructure.TableDataAssertions.AssertUnique(");
